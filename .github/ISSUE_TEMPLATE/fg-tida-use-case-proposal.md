---
name: FG-TIDA Use Case Proposal
about: Submit a use case to the ITU-T Focus Group on Trust and Interoperable Digital
  Identity for Agentic AI
title: "[Use Case] <short title>"
labels: use-case
assignees: ''
type: Feature
...
> Complete every field. Replace the angle-bracket placeholders. Tick boxes with [x].
...
**Crosses organisational boundary?** *(required)*
- [ ] Yes (specify): 
- [ ] No
...
|---|---|---|---|
| Dynamic Identity | [ ] | [ ] | |
| Continuous Trust and Attestation | [ ] | [ ] | |
| Delegation | [ ] | [ ] | |
| Discovery and Cross-Border Trust | [ ] | [ ] | |
...
|---|---|---|---|
| 1 | Legal / Business / Technical | | Must / Should / Nice-to-have |
| 2 | Legal / Business / Technical | | Must / Should / Nice-to-have |
| 3 | Legal / Business / Technical | | Must / Should / Nice-to-have |
| 4 | Legal / Business / Technical | | Must / Should / Nice-to-have |
| 5 | Legal / Business / Technical | | Must / Should / Nice-to-have |
